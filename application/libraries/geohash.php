...
*/
 ...
 function clearCoords() {
  ...
  /*
   * function used to create geohash code from latitude and longitude
   */ 
  function createHash() {
  ...
  //  echo "longitude:".$lng."<br>";
    if(isset($this->precision)) {
      ...
      //echo $lap."<br>";
      $lop = strlen($lng)-strpos($lng,".");//echo $lap."<br>";
  ...
  /*
   * function is used to convert geohash code into latitude and longitude
   */ 
  function parseHash() {
    $table = "0123456789bcdefghjkmnpqrstuvwxyz";
    $hash = $this->hash;
